...
AK::StandardFormatter default_format_for_field(FormatField field)
{
    ...
    switch (field) {
    case Year:
        return { .m_mode = Decimal, .m_zero_pad = true, .m_width = 4, .m_precision = {} };
    case Month:
    case Day:
    case Hour24:
    case Hour12:
    case Minute:
    case Second:
        return { .m_mode = Decimal, .m_zero_pad = true, .m_width = 2, .m_precision = {} };
    case SecondFraction:
        return { .m_mode = Decimal, .m_zero_pad = true, .m_width = 9, .m_precision = {} };
    case TimezoneName:
    case TimezoneOffset:
    case TimezoneOffsetWithColon:
        return { .m_mode = String, .m_width = {}, .m_precision = {} };
    }
    VERIFY_NOT_REACHED();
}
