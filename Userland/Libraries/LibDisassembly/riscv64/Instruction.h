...
struct DisplayStyle {
    ...
    enum class UseAliases {
        No,
        Yes,
    } use_aliases { UseAliases::Yes };
    ...
    enum class RelativeAddressStyle {
        Offset,
        Symbol,
...
public:
    ...
    virtual DeprecatedString to_deprecated_string(u32, Optional<SymbolProvider const&>) const override;
