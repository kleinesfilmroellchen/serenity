...
public:
    ...
    virtual ErrorOr<void> write_samples(Span<Sample> samples) override;
    virtual ErrorOr<void> finalize() override; // You can finalize manually or let the destructor do it.
