    ...
    , m_parameter(parameter)
{
    if (!is_logarithmic()) {
        ...
        auto min_log = log(m_parameter.min_value()).raw();
        auto max_log = log(m_parameter.max_value()).raw();
        auto value_log = log(m_parameter.value()).raw();
