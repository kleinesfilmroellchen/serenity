...
TEST_CASE(check_all_instructions)
{
    Array all_instructions = {
        // RV32I
        static_cast<NonnullOwnPtr<InstructionImpl>>(make<LoadUnsignedImmediate>(0x74a05000, 1_x)),
        make<AddUnsignedImmediateToProgramCounter>(0x6a7000, 2_x),
...
TEST_CASE(asinh)
{
    Array asinh_instructions = {
        ...
        make<AddUnsignedImmediateToProgramCounter>(0xfffbf000, 10_x),
        ...
        make<AddUnsignedImmediateToProgramCounter>(0xfffbf000, 11_x),
        ...
        make<AddUnsignedImmediateToProgramCounter>(0xfffbf000, 12_x),
